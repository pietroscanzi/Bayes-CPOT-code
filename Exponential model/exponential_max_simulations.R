#Exponential posterior simulations
...
for(s in 1:nconf){
  ...
  for(i in 1:Nsim){
    ...
    params <- fit.bayes.exp$parameters
...
save(true.par.exp, Q.ext.true.exp, R.lev.true.exp, quant.ci.exp, quant.cov.exp,
     ...
     file = "exponential_max_simulations.RData")
