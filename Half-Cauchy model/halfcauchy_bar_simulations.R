#Half-Cauchy posterior simulations (bar parameterization)
...
for(s in 1:nconf){
  ...
  for(i in 1:Nsim){
    ...
    params.bar <- fit.bayes.hc$parameters
    params <- params.bar
...
save(true.par.hc, Q.ext.true.hc, R.lev.true.hc, quant.ci.hc, quant.cov.hc,
     ...
     file = "halfcauchy_bar_simulations.RData")
