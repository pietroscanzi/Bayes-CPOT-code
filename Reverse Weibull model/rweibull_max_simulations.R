#Reverse Weibull posterior simulations
...
for(s in 1:nconf){
  ...
  for(i in 1:Nsim){
    ...
    params <- fit.bayes.rw$parameters
...
save(true.par.rw, Q.ext.true.rw, R.lev.true.rw, quant.ci.rw, quant.cov.rw,
     ...
     file = "rweibull_max_simulations.RData")
