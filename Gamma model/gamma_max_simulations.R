...
for(s in 1:nconf){
  ...
  for(i in 1:Nsim){
    ...
    params <- fit.bayes.gam$parameters
...
save(true.par.gam, Q.ext.true.gam, R.lev.true.gam, quant.ci.gam, quant.cov.gam,
     ...
     file = "gamma_max_simulations.RData")
